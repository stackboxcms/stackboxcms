<?php
namespace Module\Page\Template;
...
class DOMElement extends \DOMElement
{
    ...
    */  
    ...
    /**
     * Collects all attributes and returns them in key/value array
     * WHY a function like this doesn't exist for DOMElement is beyond me...
     *
     * @return array
     */
    ...
    /**
     * Replace current node with given HTML content
     */
    public function replaceWith($content)
    {
        ...
        if($this->parentNode) {
            $newNode = $this->parentNode->insertBefore($fragment, $this);
