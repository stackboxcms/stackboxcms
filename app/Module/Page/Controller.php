        ...
        if(false === $moduleResponse) {
            ...
            if('html' == $request->format) {
                ...
                if($moduleResponse instanceof \Alloy\Module\Response) {
                    ...
                    $response = $kernel->response($moduleResponse->status());
                  ...
                  <div class="cms_ui cms_ui_controls">
                    ...
                    <ul>
                      ...
                      if($module->id > 0) {
                        // Settings link
                        $content .= '
                        <li><a href="' . $kernel->url(array('page' => $page->url, 'module_name' => ($module->name) ? $module->name : $this->name(), 'module_id' => (int) $module->id, 'module_action' => 'settings'), 'module') . '">Settings</a></li>';
                        $content .= '
                        <li><a href="' . $kernel->url(array('page' => $page->url, 'module_name' => 'page_module', 'module_id' => 0, 'module_item' => (int) $module->id, 'module_action' => 'delete'), 'module_item') . '">Delete</a></li>';
                      }
                      $content .= '
                       </ul>
                      </li>
